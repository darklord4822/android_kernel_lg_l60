...
#define CUST_EINT_TP_WAKEUP_NUM              2
#define CUST_EINT_TP_WAKEUP_DEBOUNCE_CN      0
#define CUST_EINT_TP_WAKEUP_POLARITY         CUST_EINT_POLARITY_LOW
#define CUST_EINT_TP_WAKEUP_SENSITIVE        CUST_EINT_EDGE_SENSITIVE
#define CUST_EINT_TP_WAKEUP_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE
