...
hwPowerOn(CAMERA_POWER_VCAM_D2, VOL_1800,"flashlight");
	mdelay(2); 
...
hwPowerDown(CAMERA_POWER_VCAM_D2,"flashlight");
...
//<2014/03/07-Yuting Shih. Add for flashlight control/turn on test.
//#define LM3642_TEST_ENABLE

#if defined( LM3642_TEST_ENABLE )
static void lm3642_i2c_test( void )
{
#if 0
int ret = 0;
char databuf[2];
...
char databuf[16];
  ...
  show_torchmode_on( NULL, NULL, (char*)&databuf[0] );
  mdelay( 700 );
  show_torchmode_off( NULL, NULL, (char*)&databuf[0] );

#endif
}
#endif
//>2014/03/07-Yuting Shih.
...
//<2014/03/06-Yuting Shih. Integrate flashlight LED.
#if defined( CONFIG_ARIMA_LO1_HW ) || defined( CONFIG_ARIMA_LO2_HW )
	i2c_register_board_info( I2C_USAGE_NUM, &i2c_lm3642, 1 );
